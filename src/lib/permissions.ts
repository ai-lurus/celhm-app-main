...
export const rolePermissions = {
  ...
  VENDEDOR: {
    ...
    canManageInventory: false,
    canManageCatalog: true, // Needed to view prices/stock
    canDeleteOrders: false,
    canEditPrices: false, // No modifications
    canViewAllBranches: false,
  ...
  ALMACENISTA: {
    ...
    canManageTickets: false,
    canManageCustomers: false,
    canManageInventory: true, // Ingreso de mercancías
    canManageCatalog: true, // View prices
    canDeleteOrders: false,
    canEditPrices: false,
    canViewAllBranches: false,
    canUpdateTickets: false,
...
const roleDefaultRoutes: Record<string, string> = {
  TECNICO: '/dashboard/laboratorio',
  VENDEDOR: '/dashboard/sales',
  ALMACENISTA: '/dashboard/inventory',
}
