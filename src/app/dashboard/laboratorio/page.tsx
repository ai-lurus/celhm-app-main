...
export default function TicketsPage() {
  ...
  const { data: branches = [] } = useBranches({
    enabled: can("canViewAllBranches"),
  });
  ...
  const [branchId, setBranchId] = useState<number | "">(
    user?.branchId || (branches.length > 0 ? branches[0].id : 1)
  );
  ...
  const handleSelectExistingCustomer = (c: any) => {
    setFormData({ ...formData, customerName: c.name, customerPhone: c.phone || "", customerEmail: c.email || "" });
  ...
  const handleCloseQuickCreate = () => {
    ...
    setNewCustName(""); setNewCustPhone(""); setNewCustPhoneAlt(""); setNewCustRFC(""); setNewCustEmail(""); setNewCustNotes("");
  };
  ...
  const handleSaveQuickCustomer = async () => {
    ...
    const dupEmail = emailNorm ? existingCustomers.find((c: any) => c.email && normalizeEmail(c.email) === emailNorm) : undefined;
    ...
    try {
      ...
      setFormData({ ...formData, customerName: newCustName.trim(), customerPhone: newCustPhone.trim(), customerEmail: newCustEmail.trim() });
  ...
  const handleStatusPriceChange = (field: keyof StatusForm, value: string) => {
    if (!/^\d*\.?\d*$/.test(value)) return;
      ...
      if (editingTicket) {
        await updateTicket.mutateAsync({
          ...
          data: {
            ...
            estimatedCost: formData.estimatedCost
              ? parseFloat(formData.estimatedCost.toString())
              : undefined,
            finalCost: formData.finalCost
              ? parseFloat(formData.finalCost.toString())
              : undefined,
        ...
        await createTicket.mutateAsync({
          ...
          advancePayment: formData.advancePayment
            ? parseFloat(formData.advancePayment.toString())
            : undefined,
          internalNotes: formData.internalNotes || undefined,
          condition: formData.condition || undefined,
          accessories: formData.accessories || undefined,
    ...
    try {
      await updateTicketState.mutateAsync({
        ...
        data: {
          ...
          estimatedCost: statusForm.estimatedCost
            ? parseFloat(statusForm.estimatedCost.toString())
            : undefined,
          finalCost: statusForm.finalCost
            ? parseFloat(statusForm.finalCost.toString())
            : undefined,
      ...
      toast({
        ...
        description:
          error?.message || "Error al actualizar el estado del ticket",
      });
    }
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap justify-between items-start gap-3">
        <div>
          ...
          <p className="text-muted-foreground">
            Gestión de notas de laboratorio
          </p>
        </div>
        <button
          onClick={handleOpenCreate}
          className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md shrink-0"
        >
          Nueva Nota
        </button>
      </div>
      ...
      <div className="bg-card p-4 rounded-lg shadow">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
          ...
          <div>
            ...
            >
              {branches.length > 1 && can("canViewAllBranches") && (
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <div className="bg-card p-8 rounded-lg shadow-2xl w-full max-w-3xl space-y-6">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handlePriceChange("estimatedCost", e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              handlePriceChange("finalCost", e.target.value)
                            }
                            onFocus={(e) => e.target.select()}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handlePriceChange("advancePayment", e.target.value)
                          }
              ...
              <form onSubmit={handleUpdateStatus} className="space-y-4 mt-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setStatusForm({ ...statusForm, solution: e.target.value })
                    }
                    className="w-full border border-border rounded-md px-3 py-2"
                  />
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleStatusPriceChange("estimatedCost", e.target.value)
                      }
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleStatusPriceChange("finalCost", e.target.value)
                      }
      ...
      {isViewModalOpen && viewingTicket && (
        <div className="fixed inset-0 bg-black bg-opacity-60 z-50 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <div className="bg-card p-8 rounded-lg shadow-2xl w-full max-w-lg space-y-4">
              <h2 className="text-2xl font-bold text-foreground">
                Detalles del Ticket
              </h2>
              ...
              <div className="space-y-3 pt-4">
                ...
                <div className="flex justify-between border-b pb-2">
                  ...
                  <span
                    className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getStateColor(viewingTicket.state)}`}
                  >
                ...
                <div className="flex justify-between border-b pb-2">
                  ...
                  <span className="font-medium text-foreground text-right">
                    {viewingTicket.device}{" "}
                    {viewingTicket.brand ? `(${viewingTicket.brand}` : ""}
                    {viewingTicket.model
                      ? ` - ${viewingTicket.model})`
                      : viewingTicket.brand
                        ? ")"
                ...
                <div className="flex justify-between border-b pb-2">
                  ...
                  <span className="font-medium text-foreground">
                    {viewingTicket.estimatedTime || 0} días
                  </span>
                </div>
          ...
          <div className="bg-card rounded-xl shadow-2xl w-full max-w-md">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input ref={newCustNameRef} type="text" value={newCustName} onChange={(e) => setNewCustName(e.target.value)}
              ...
              <div>
                ...
                <input type="tel" value={newCustPhone} onChange={(e) => setNewCustPhone(e.target.value)}
                  className="w-full px-3 py-2 border border-border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none bg-background text-foreground"
                  placeholder="Número de teléfono"
                  onKeyDown={(e) => { if (e.key === "Escape") handleCloseQuickCreate(); }} />
              </div>
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">Teléfono de Respaldo</label>
                <input type="tel" value={newCustPhoneAlt} onChange={(e) => setNewCustPhoneAlt(e.target.value)}
                  className="w-full px-3 py-2 border border-border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none bg-background text-foreground"
              ...
              <div>
                ...
                <input type="text" value={newCustRFC} onChange={(e) => setNewCustRFC(e.target.value)}
                  className="w-full px-3 py-2 border border-border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none bg-background text-foreground"
              ...
              <div>
                ...
                <textarea value={newCustNotes} onChange={(e) => setNewCustNotes(e.target.value)} rows={2}
            ...
            <div className="px-6 pb-6 flex justify-end space-x-3">
              <button type="button" onClick={handleCloseQuickCreate}
                className="px-4 py-2 border border-border rounded-md text-foreground hover:bg-muted transition-colors">
                Cancelar
              </button>
              <button type="button" onClick={handleSaveQuickCustomer} disabled={createCustomer.isPending}
