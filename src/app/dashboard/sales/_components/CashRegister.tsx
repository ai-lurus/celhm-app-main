  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-7xl h-[95vh] flex flex-col">
        {/* Header Bar */}
        <div className="bg-blue-600 text-white px-6 py-3 flex items-center rounded-t-lg">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <select
                    value={form.sellerId}
                    onChange={(e) =>
                      onFormChange({ ...form, sellerId: e.target.value })
                    }
                    ...
                    return (
                      ...
                      >
                        <input
                          ...
                          title={
                            isRepairOrder
                              ? "La cantidad de órdenes de reparación está fija en 1"
                              : ""
                          }
                        />
                ...
                <div className="space-y-2 relative">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        onFormChange({ ...form, productSearch: e.target.value })
                      }
                  ...
                  {form.productSearch && filteredStockItems.length > 0 && (
                    <div className="absolute z-10 bottom-full mb-1 w-full bg-white border border-gray-300 rounded-md shadow-lg max-h-60 overflow-y-auto">
                      {filteredStockItems.slice(0, 10).map((item) => {
                        ...
                        return (
                          <button
                            ...
                            className={`w-full px-4 py-2 text-left hover:bg-gray-100 text-sm ${isOutOfStock ? "opacity-60" : ""}`}
                          >
                            <div className="flex justify-between items-start">
                              ...
                              <span
                                className={`text-xs font-semibold px-1.5 py-0.5 rounded ml-2 shrink-0 ${
                                  isOutOfStock
                ...
                <div className="space-y-2">
                  ...
                  {form.discountPercent && form.discount > 0 && (
                    <div className="text-xs text-gray-600">
                      ...
                      {calculateCashRegisterDiscount(form).toLocaleString(
                        "es-MX",
                  ...
                  {!form.discountPercent && form.discount > 0 && (
                    <div className="text-xs text-gray-600">
                      Descuento: $
                      {form.discount.toLocaleString("es-MX", {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      })}
                    </div>
                  ...
                  {form.ticketDetails && (
                    <div
                      ...
                      title={form.ticketDetails}
                    >
                      {form.ticketDetails.length > 30
                        ? `${form.ticketDetails.substring(0, 30)}...`
                        : form.ticketDetails}
                    </div>
                  )}
                </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    onFormChange({ ...form, ticketDetails: e.target.value })
                  }
              ...
              {filteredTickets.length === 0 ? (
                ...
                <div className="divide-y">
                  {filteredTickets.map((ticket) => {
                    const ticketPrice =
                      ticket.finalCost || ticket.estimatedCost || 0;
                    ...
                    return (
                      <button
                        key={ticket.id}
                        onClick={() =>
                          !isAlreadyAdded && handleAddTicket(ticket)
                        }
                        ...
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-gray-700">
                              ...
                              <div>
                                <strong>Dispositivo:</strong> {ticket.device}
                              </div>
                              {ticket.brand && (
                                <div>
