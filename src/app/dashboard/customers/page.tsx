            ...
            <div className="space-y-4">
              ...
              {viewingCustomer.notes && (
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-900">{viewingCustomer.notes}</p>
                </div>
              )}
              {viewingCustomer.tickets && viewingCustomer.tickets.length > 0 && (
                <div>
                  <label className="block text-sm font-medium text-gray-700">Órdenes de Reparación</label>
                  <p className="mt-1 text-sm text-gray-900">{viewingCustomer.tickets.length} órdenes</p>
                </div>
              )}
              {viewingCustomer.sales && viewingCustomer.sales.length > 0 && (
                <div>
                  <label className="block text-sm font-medium text-gray-700">Ventas</label>
                  <p className="mt-1 text-sm text-gray-900">{viewingCustomer.sales.length} ventas</p>
                </div>
              )}
            </div>
