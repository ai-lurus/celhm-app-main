...
const ReceiptCopy = ({ ticket }: { ticket: Ticket }) => (
  <View style={styles.section}>
    ...
    <View style={styles.gridContainer}>
      <View style={styles.leftColumn}>
        <View style={styles.row}>
          ...
          <Text style={[styles.label, { width: 50, marginLeft: 10 }]}>
            FECHA:
          </Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>
            {ticket.device} {ticket.model}
          </Text>
          <Text style={[styles.label, { width: 40, marginLeft: 10 }]}>
            SERIE:
          </Text>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>
            {ticket.warrantyDays ? `${ticket.warrantyDays} DÍAS` : "NO APLICA"}
          </Text>
        </View>
    ...
    <Text style={styles.terms}>
      Nota: Sin el presente recibo no se entregara aparato alguno. En caso de
      extravío de este folio exclusivamente se hará entrega al propietario,
      quien tendrá que presentar una identificación oficial (IFE/INE, cédula
      profesional, licencia de conducir o pasaporte vigentes). DESPUÉS DE 30
      DÍAS NO NOS HACEMOS RESPONSABLES POR NINGÚN EQUIPO. En equipos mojados,
      golpeados, intervenidos o que hayan tenido uso inadecuado NO HAY GARANTÍA.
      TODA REVISIÓN GENERA UN COSTO DE $50 a $100 (según el modelo).
    </Text>
